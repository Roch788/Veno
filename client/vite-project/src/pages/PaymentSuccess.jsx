    ...
    return (
        <div className="min-h-[70vh] flex flex-col items-center justify-center p-4">
            <div className="bg-slate-900 p-10 rounded-3xl shadow-2xl max-w-md w-full text-center border-t-8 border-green-500 transform transition-all hover:-translate-y-1">
                ...
                <h1 className="text-4xl font-black text-slate-100 mb-4">Booking Confirmed!</h1>
                ...
                <div className="space-y-4">
                    ...
                    <Link to="/" className="block w-full bg-slate-800 hover:bg-slate-700 text-slate-100 font-bold py-4 px-6 rounded-xl transition">
